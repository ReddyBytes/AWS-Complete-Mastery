...
**Prev:** [← Auto Scaling & Load Balancing](../03_compute/auto_scaling.md) &nbsp;|&nbsp; **Next:** [S3 Object Storage →](../04_storage/s3.md)

**Related Topics:** [EC2](../03_compute/ec2.md) · [ECS](../10_containers/ecs.md) · [CI/CD Pipeline](../13_devops_cicd/cicd_pipeline.md) · [CloudFormation](../09_iac/cloudformation.md)
