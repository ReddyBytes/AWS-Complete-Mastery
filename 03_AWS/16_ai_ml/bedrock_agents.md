...
**Prev:** [← Amazon Bedrock](../16_ai_ml/bedrock.md) &nbsp;|&nbsp; **Next:** [Knowledge Bases (RAG) →](../16_ai_ml/bedrock_knowledge_bases.md)

**Related Topics:** [Amazon Bedrock](../16_ai_ml/bedrock.md) · [Knowledge Bases (RAG)](../16_ai_ml/bedrock_knowledge_bases.md) · [Lambda](../11_serverless/lambda.md) · [Step Functions](../11_serverless/step_functions.md)
