...
**Prev:** [← API Gateway](../11_serverless/api_gateway.md) &nbsp;|&nbsp; **Next:** [SQS, SNS & EventBridge →](../11_serverless/sqs_sns_eventbridge.md)

**Related Topics:** [API Gateway](../11_serverless/api_gateway.md) · [DynamoDB](../07_databases/dynamodb.md) · [Lambda](../11_serverless/lambda.md) · [Cognito](../06_security/cognito.md)
